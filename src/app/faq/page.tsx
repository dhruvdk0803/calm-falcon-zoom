    ...
    },
    {
      ...
      a: (
        <>
          ...
          <a href="mailto:contact@supersmashkc.com" className="text-comic-blue underline hover:text-comic-red transition-colors">Click here to request it</a> if you would like to fill it out beforehand. <br /><br />
          Or you can go here to complete your waiver form online: <br />
          <a href="mailto:contact@supersmashkc.com" className="text-comic-blue underline hover:text-comic-red transition-colors">WaiverFile | Online Waiver Form Entry</a>
        </>
      )
    },
    {
