...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark scroll-smooth">
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${bebasNeue.variable} antialiased bg-[#050505] text-gray-300 selection:bg-red-600 selection:text-white overflow-x-hidden`}
      >
